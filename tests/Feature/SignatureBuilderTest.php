...
{
    /** @test */
    public function it_offers_short_and_long_codes()
    {
    ...
    /** @test */
    public function it_functions_given_only_long_code()
    {
        $newCommand = new NewCommand();
        $output = $newCommand->buildSignatureOption([
            'long' => 'editor',
    ...
    /** @test */
    public function it_sets_expectation_for_values_if_option_expects_parameters()
    {
        $newCommand = new NewCommand();
        $output = $newCommand->buildSignatureOption([
            'long' => 'editor',
    ...
    /** @test */
    public function it_does_not_set_expectation_for_values_if_option_does_not_expect_parameters()
    {
        $newCommand = new NewCommand();
        $output = $newCommand->buildSignatureOption([
            'long' => 'editor',
    ...
    /** @test */
    public function it_defines_description()
    {
        $newCommand = new NewCommand();
        $output = $newCommand->buildSignatureOption([
            'long' => 'editor',
