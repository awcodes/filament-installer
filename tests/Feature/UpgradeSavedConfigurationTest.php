...
class UpgradeSavedConfigurationTest extends TestCase
{
    ...
    private $newConfiguration = [
        'THING' => [
            ...
            'default' => 'flibble',
            'description' => [
                'The THING parameter enables Filament Installer to do a thing.',
        ...
        'ANOTHER_THING' => [
            ...
            'default' => 'false',
            'description' => [
                'The ANOTHER_THING parameter enables Filament Installer to do a another thing.',
...
# ------------------------------------------------------------------------------
# 1-Jan-2000 12:00 am (auto-generated by Filament Installer):
# ------------------------------------------------------------------------------
