...
{
    /** @test */
    public function it_gets_the_value_of_of_a_shell_environment_variable()
    {
    ...
    /** @test */
    public function it_returns_null_if_a_shell_environment_variable_is_missing()
    {
    ...
    /** @test */
    public function it_returns_null_if_a_shell_environment_variable_is_empty()
    {
